...
if __name__ == "__main__":
    ...
    while True:
        ...
        print("accelerometer = {{'ax': {0[x]:2.3f}, 'ay': {0[y]:2.3f}, 'az': {0[z]:2.3f}}}".format(accel), end=" ")
        gyro = mpu9250.readGyro()
        print("Gyroscope = {{'gx': {0[x]:2.3f}, 'gy': {0[y]:2.3f}, 'gz': {0[z]:2.3f}}}".format(gyro), end=" ")
        mag = mpu9250.readMagnet()
        print("Magnetometer = {{'mx': {0[x]:2.3f}, 'my': {0[y]:2.3f}, 'mz': {0[z]:2.3f}}}".format(mag), end=" ")
        temp = mpu9250.readTemperature()
        print ("temp = {0:2.3f}".format(temp))
        time.sleep(0.3)
